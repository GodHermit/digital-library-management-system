...
export interface RowStepsProps extends React.HTMLAttributes<HTMLButtonElement> {
  ...
  /**
   * Whether the steps are readonly.
   *
   * @default false
   */
  isReadOnly?: boolean;
            ...
            return (
              ...
              >
                <button
                  ...
                  className={cn(
                    'group flex w-full flex-row items-center justify-center gap-x-3 rounded-large py-2.5',
                ...
                >
                  ...
                  <div className="max-w-full flex-1 text-start">
                    <div
                      className={cn(
                        'text-small font-medium whitespace-nowrap text-default-foreground transition-[color,opacity] duration-300 lg:text-medium',
                        !isReadOnly && 'group-active:opacity-80',
                        {
